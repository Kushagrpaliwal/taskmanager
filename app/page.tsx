      ...
      <Card className="w-full max-w-md relative border-0 shadow-2xl shadow-primary/10 backdrop-blur-sm bg-white/90">
        ...
        <CardContent className="space-y-4 pt-4">
          ...
          <div className="grid grid-cols-2 gap-3">
            <Button variant="outline" className="rounded-xl h-11 hover:bg-accent/80" onClick={() => router.push("/dashboard")}>
          ...
          <form onSubmit={handleLogin} className="space-y-4">
            ...
            <Button type="submit" className="w-full h-11 rounded-xl bg-gradient-to-r from-primary to-purple-600 hover:opacity-90 shadow-lg shadow-primary/25 transition-all group">
              Sign in
